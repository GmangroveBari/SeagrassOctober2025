...
format:
  html:
    ...
    include-in-header:
      text: |
        <style>
        .quarto-float-caption { text-align: left !important; }
        #tbl-sed table { width: auto; margin: 0 auto; }
        </style>
editor: visual
execute: 
  echo: false
...
Upon debarkation, the group was trained on the [seagrass monitoring protocol](https://docs.google.com/document/d/1lNSAIABPAdRw56UiYpi_fDJnMoSk4MEQW6SEBqg8sh4/edit?usp=sharing). This included:
...
depth <- read.csv("https://raw.githubusercontent.com/GmangroveBari/SeagrassOctober2025/refs/heads/main/202510-SeagrassDataAMIkidsConcatated.csv")
...
Depth_fig <- ggplot(Mean_Depth, aes(x = Day, y = AvgD)) + 
  geom_bar(stat = 'identity', position = 'dodge') + geom_col(fill = "ORANGE")
...
sed <- read_csv("https://raw.githubusercontent.com/GmangroveBari/SeagrassOctober2025/refs/heads/main/202510-SeagrassDataAMIkidsConcatated.csv", col_select = c(Day, SedimentType))
...
# Remove empty row
mean_sed <- mean_sed[-c(1), ]

# Generate a markdown table
knitr::kable(mean_sed, format = "html", align = "cc", digits = 1) %>%
...
Seagrass1 <- read.csv("https://raw.githubusercontent.com/GmangroveBari/SeagrassOctober2025/refs/heads/main/202510-SeagrassDataAMIkidsConcatated.csv")
...
```{r}
#| label: tbl-means
#| tbl-cap: "Overall averages for several different seagrass metrics assessed from Oct. 20-25, 2025. Appearance and Epiphyte Density were scored on an objective scale from 1 (Excellent/None) to 5 (Poor/Heavy)."

Table2a <- read.csv("https://raw.githubusercontent.com/GmangroveBari/SeagrassOctober2025/refs/heads/main/202510-SeagrassDataAMIkidsConcatated.csv")
...
summary_table <- summary_table %>%
  filter(!row_number() %in% c(4))


# rename columns 4-6

colnames(summary_table)[4] <- "Epiphyte Density"
colnames(summary_table)[5] <- "Shoots/m2"
colnames(summary_table)[6] <- "Blade Length (cm)"

# Generate a markdown table
knitr::kable(head(summary_table), digits = 1,  align = "lccccc")
...
Epiphyte <- read.csv("https://raw.githubusercontent.com/GmangroveBari/SeagrassOctober2025/refs/heads/main/202510-SeagrassDataAMIkidsConcatated.csv")
